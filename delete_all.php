...
<body>
  ...
  <form name="deleteForm" action="delete_reg2.php" method="POST" >
    <div class="col-md-6">
    <div class="round1">
    <p style="font-size: 20px" align="center" >Are You Sure You Want To Delete All Personal Details ?</p>
    <div class="form-group" >
        <input type="submit" class="btn btn-danger form-control" value="Delete" style="height: 40px">
      </div>
...
<form name="deleteForm" action="delete_reg.php" method="POST" >
    <div class="col-md-6">
    <div class="round1">
    <p style="font-size: 20px" align="center" >Are You Sure You Want To Delete All Academic Details ?</p>
    <div class="form-group" >
        <input type="submit" class="btn btn-danger form-control" value="Delete" style="height: 40px">
      </div>
    </div>
...
<form name="deleteForm" action="delete_reg.php" method="POST" style="margin-left: 480px">
    <div class="col-md-6">
    <div class="round1">
    <p style="font-size: 20px" align="center" >Delete According To Registration Form:</p>
    <div class="form-group" >
        <input type="submit" class="btn btn-danger form-control" value="Delete" style="height: 40px">
      </div>
    </div>
